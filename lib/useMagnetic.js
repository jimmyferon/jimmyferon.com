...
/* Découpe une liste CSS aux virgules de premier niveau uniquement. */
...
function install() {
  ...
  document.addEventListener("pointerover", (e) => {
    ...
    /* On garde les transitions du thème (fond, couleur, bordure) mais pas celle
       ...
       c'est ce qui figeait « Book a call » dans Services, dont l'apparition
       pose une transition de transform d'une seconde avec un délai.
       Les valeurs cubic-bezier(…) contiennent des virgules : on ne découpe
       qu'aux virgules hors parenthèses. */
    const kept = splitTop(getComputedStyle(el).transition)
